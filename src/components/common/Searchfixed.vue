<template>
  <div class="searchfixedbox">
    <div class="searchbox">
        ...
        <ul class="searchchooseul" v-if="ischoose">
            <li @click="choose(1)">宝贝</li>
            <li @click="choose(2)">店铺</li>
        </ul>
        ...
        <!--<el-input
            ...
            icon="search"
            v-model="input2"
            :on-icon-click="handleIconClick" class="headersearch"  @keyup="get($event)">
        </el-input>-->
    </div>
...
export default {
    ...
    methods: {
        ...
        choose(index){
            if(index==1){
                this.searchchoose='宝贝';
            }else{
                this.searchchoose='店铺';
            }
            this.ischoose=!this.ischoose;
        },
        get(event){
